      ...
      <div class="col-md-10  p-4 borber">
        <div class="row align-items-center mb-4">
          ...
          <div class="col text-end ">
            <a class="btn btn-success px-3" role="button" aria-disabled="true" href="register.php">
              ...
              <tr>
                ...
                <td class="text-center">
                  <form action="process.php" method="POST">
                    <input type="hidden" name="acao" id="acao" value="SELECTID">
                ...
                <td class="text-center">
                  <a class="dropdown-item" onclick="modalRemover(<?=$admin[0]?>,'idDeletar')">
    ...
    <div class=" modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="process.php" method="post">
            <input type="hidden" class="form-control" id="idDeletar" name="idDeletar" >
            <input type="hidden" class="form-control" value="DELETE" name="acao" >
