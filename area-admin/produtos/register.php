...
if (!empty($_POST)) {
  ...
  $descricao = $produtoDao['descricaoProduto'];
            ...
            <div class="card-body row" style="align-items: center; justify-content: center;">
              <div class="col-md-2   text-center">
                <div class="bg-white rounded border">
                  <img id="preview" src="../../imgs/produtos/<?= $imagem_Produto != "" ? $imagem_Produto : 'padrao.jpg'; ?>" alt="..." class="rounded  w-100  " style="height:200px; object-fit: cover; border:4px solid #ccc">
                </div>
              </div>
              <div class=" col-md-10">
                <div class="row">
                  <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" name="nome" maxlength="50" id="nome" value="<?= $nome ?>" required>
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" name="preco" maxlength="14" id="preco" value="<?= $preco ?>" required>
                    <div class="invalid-feedback">
                      Adicione o preço
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="descricao" maxlength="100" id="descricao" value="<?= $descricao ?>" required>
                    <div class="invalid-feedback">
