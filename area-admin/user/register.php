              ...
              <div class=" col-md-10">
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="invalid-feedback">Sobrenome Invalido</div>
                  </div>
                  <div class="col-md-3 mb-3">
                    <label for="cpf" class="col-form-label">CPF:</label>
                    <input type="text" class="form-control" name="cpf" maxlength="50" id="cpf" data-mask="000.000.000-00"  data-mask-selectonfocus="true" required>
                ...
                <div class="row">
                  <div class="col-md-3">
                    ...
                    <div class="invalid-feedback">Data Invalida</div>
                  </div>
                  <div class="col-md-6">
